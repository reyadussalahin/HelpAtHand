...
public class Catagory extends Monga {
    ...
    public Catagory(Database db) throws SQLException {
        this.connection = db.getConnection();
    }

    public void createTable() throws SQLException {
        String sql = "CREATE TABLE IF NOT EXISTS catagory (" +
    ...
    public boolean exists(String name) throws SQLException {
        String sql = "SELECT id FROM catagory WHERE name = ?";
    ...
    public boolean exists(int id) throws SQLException {
        String sql = "SELECT id FROM catagory WHERE id = ?";
        PreparedStatement pst = connection.prepareStatement(sql);
        pst.setInt(1, id);
        return (pst.executeQuery()).next();
    }
    ...
    public boolean delete(String name) throws SQLException {
        String sql = "DELETE FROM catagory WHERE name = ?";
        PreparedStatement pst = connection.prepareStatement(sql);
        pst.setString(1, name.toLowerCase());
        return (pst.executeUpdate() != 0);
    }
    ...
    public boolean update(String old_name, String new_name) throws SQLException {
        ...
        String sql = "UPDATE catagory SET name = ? WHERE name = ?";
        PreparedStatement pst = connection.prepareStatement(sql);
    ...
    public boolean update(String name, int new_id) throws SQLException {
        ...
        String sql = "UPDATE catagory SET id = ? WHERE name = ?";
        PreparedStatement pst = connection.prepareStatement(sql);
        pst.setInt(1, new_id);
    ...
    public String getName(int id) throws SQLException {
        String sql = "SELECT name FROM catagory WHERE id = ?";
        PreparedStatement pst = connection.prepareStatement(sql);
        pst.setInt(1, id);
        ResultSet rs = pst.executeQuery();
    ...
    private ResultSet getColumn(String col_name) throws SQLException {
        ...
        String sql = "SELECT " + col_name + " FROM catagory";
        Statement st = connection.createStatement();
    ...
    private ResultSet getColumn(String col_name, int limit) throws SQLException {
        ...
        String sql = "SELECT " + col_name + " FROM catagory LIMIT ?";
        PreparedStatement pst = connection.prepareStatement(sql);
        pst.setInt(1, limit);
    ...
    public Row[] getRows(int limit) throws SQLException {
        ...
        String sql = "SELECT id, name FROM catagory LIMIT ?";
        PreparedStatement pst = connection.prepareStatement(sql);
        pst.setInt(1, limit);
        ResultSet rs = pst.executeQuery();
        List<Row> list = new ArrayList<Row>();
    ...
    public void print() throws SQLException {
        Row[] array = getRows();
        System.out.println("TABLE \"catagory\":");
        System.out.println("--------------------------------------------------------------------------------");
        for(int i=0; i<array.length; i++) System.out.println(array[i]);
    }

    public void dropTable() throws SQLException {
        String sql = "DROP TABLE IF EXISTS catagory";
        Statement st = connection.createStatement();
        st.execute(sql);
    }
}
